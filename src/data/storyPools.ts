/**
 * «Пулы» квестов торговцев (EFT 1.1). У 164 квестов tarkov.dev вместо предшественников стоит
 * otherRequirements: globalVariable ≥ N. Каждая переменная — счётчик одного торговца на одном уровне лояльности,
 * а N — сколько квестов этого пула нужно выполнить (сверка по профилю уровня 55: tarkov-data-overlay,
 * docs/GLOBAL_VARIABLE_MECHANICS.md — счётчик равен числу выполненных квестов пула в 23 из 27 групп).
 * Кто входит в пул, публично не опубликовано; считаем квестами пула все квесты торговца на этом уровне лояльности,
 * кроме цепочек (с предшественниками), сюжетных, престижных и Арены — по размерам совпадает с эталоном ±1–2.
